...
Drivers/GPS.o: ../Drivers/GPS.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DEMPL_TARGET_STM32F4 '-DMPL_LOG_NDEBUG=1' -DMPU9250 -DEMPL -DUSE_DMP -DUSE_HAL_DRIVER -DSTM32F411xE -DDEBUG -c -I../Inc -I/Users/nick_savva/Downloads/CMSIS_5-develop/CMSIS/DSP/Include -I"/Users/nick_savva/STM32CubeIDE/workspace_1.0.1/STM32_FLIGHT_CONTROLLER/dsp_library" -I../Drivers/CMSIS/Include -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -Og -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Drivers/GPS.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
