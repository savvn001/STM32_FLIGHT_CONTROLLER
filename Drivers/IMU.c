...
float magCalibration[3] = { 1.1953125, 1.19921875, 1.15234375 }, magbias[3] = {
		-35.4058418, -98.8425751, 654.464783 }, magscale[3] = { 1, 1, 1 }; // Factory mag calibration and mag bias
float gyroBias[3] = { 0.435114503, -0.167938933, -0.587786257 }, accelBias[3] =
		{ 0.005859375, 0.0134887695, -0.0504150391 }; // Bias corrections for gyro and accelerometer
...
// measured ones.
__attribute__((optimize("-Ofast"))) void MahonyQuaternionUpdate(float ax,
